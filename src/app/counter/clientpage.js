...
const CounterClient = () => {
	...
	const getEmission = (distance, vehicle, passengers) => {
		if (!vehicle) return 'Please Select Your Vehicle'
		else if (vehicle === 'Car') {
	...
	return (
		<section>
			<section data-aos="fade-up" className="vechiles_option ">
				...
				<button
					className={`vechile_button_1 py-5  hover:text-green8 ${
						vehicle == 'Car' ? 'text-green8' : 'text-[#609966]'
					} transition`}
				...
				<button
					className={`vechile_button_2 py-5 hover:text-green8 ${
						vehicle == 'Motorcycle' ? 'text-green8' : 'text-[#609966]'
					} transition`}
				...
				<button
					className={`vechile_button_3 py-5 hover:text-green8 ${
						vehicle == 'Bus' ? 'text-green8' : 'text-[#609966]'
					} transition`}
			...
			<form data-aos="fade-up" className="distance_forms">
			...
			<section data-aos="fade-up" className="emission_info">
				<h2>Emission per Passenger</h2>
				<h1 className="text-green-700 font-bold text-3xl my-5">
					{getEmission(distance, vehicle, passengers)}
				</h1>
				<h2>Grams</h2>
				<h2>
					CO<sub>2</sub>
			...
			<section data-aos="fade-up" className="vechiles_option ">
				...
				<h3 className="my-10 mx-5 text-green6 font-bold font-paragraph text-lg sm:text-xl md:text-2xl lg:text-3xl md:mb-10">
					A single tree offsets about 20 kg of carbon dioxide each year, start
					planting now !
				</h3>
			</section>
			<form data-aos="fade-up" className="distance_forms">
