  ...
  return (
    <>
      <div className="flex  justify-center pt-[6rem] px-5">
        <div className="w-[280px] h-[210px] md:w-[450px] md:h-[300px] lg:w-[800px] lg:h-[600px]  bg-gray-300 rounded-md overflow-hidden">
      ...
      <table className='m-[6rem] border-2 border-slate-950 mx-auto text-xs sm:text-sm md:text-md lg:text-2xl '>
        <thead className='bg-[#A0C49D] text-black'>
          <tr>
            ...
            <th className='p-3 border-2 border-slate-950'>C</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td className={`border-2 border-slate-950 py-3 px-6 text-center text-black ${getcolor(aqi)}`}>{aqi}</td>
            <td className="border-2 border-slate-950 py-3 px-6 text-center">{data.so2}</td>
            <td className="border-2 border-slate-950 py-3 px-6 text-center">{data.no2}</td>
            <td className="border-2 border-slate-950 py-3 px-6 text-center">{data.pm10}</td>
            <td className="border-2 border-slate-950 py-3 px-6 text-center">{data.pm2_5}</td>
            <td className="border-2 border-slate-950 py-3 px-6 text-center">{data.o3}</td>
            <td className="border-2 border-slate-950 py-3 px-6 text-center">{data.co}</td>
          </tr>
        </tbody>
      </table>
      <table className='m-[6rem] border-2 border-slate-950 mx-auto text-xs sm:text-sm md:text-md lg:text-2xl '>
        ...
        <tbody>
          <tr>
            <td className="border-2 border-slate-950 py-3 px-6 text-center text-black bg-[#A7FFBA]">1</td>
          ...
          <tr>
            <td className="border-2 border-slate-950 py-3 px-6 text-center  text-black bg-[#F7FF96]">2</td>
            <td className="border-2 border-slate-950 py-3 px-6 text-center">
              &#91;20; 80&#41;
            </td>
            <td className="border-2 border-slate-950 py-3 px-6 text-center">
          ...
          <tr>
            <td className="border-2 border-slate-950 py-3 px-6 text-center text-black bg-[#FEA777]">3</td>
            <td className="border-2 border-slate-950 py-3 px-6 text-center">
              &#91;80; 250&#41;
            </td>
            <td className="border-2 border-slate-950 py-3 px-6 text-center">
          ...
          <tr>
            <td className="border-2 border-slate-950 py-3 px-6 text-center text-black bg-[#FF7272]">4</td>
            <td className="border-2 border-slate-950 py-3 px-6 text-center">
              &#91;250; 350&#41;
            </td>
            <td className="border-2 border-slate-950 py-3 px-6 text-center">
          ...
          <tr>
            <td className="border-2 border-slate-950 py-3 px-6 text-center text-black bg-[#B461C2]">5</td>
            <td className="border-2 border-slate-950 py-3 px-6 text-center">
              ⩾350
            </td>
            <td className="border-2 border-slate-950 py-3 px-6 text-center">
